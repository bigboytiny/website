  ...
  <div class="pageMain">
        ...
        <ul class="k1120 clearfix">
          <li>
            <div class="servicesBoxList">
              ...
              <h3>Product team</h3>
              <p>integration of internal and external resources, cooperative research and development, to ensure quality supply, and to provide professional solutions.</p>
            </div>
          </li>
          <li>
            <div class="servicesBoxList">
              ...
              <h3>Sales team</h3>
              <p>to provide multi-lingual one-on-one service, such as English, French, Russian, Japanese etc.; rapid response is a must, customer's request should be treated in 24 hours.</p>
            </div>
          </li>
          <li>
            <div class="servicesBoxList">
              ...
              <p>as the company's emerging strength, in this new economic situation, this is an important basis for the development of the company through a variety of marketing methods and big-data analysis.</p>
            </div>
          </li>
          <li>
            <div class="servicesBoxList">
              ...
              <p>ten years of meticulous work experience, to ensure the timely completion of customers’ order and the arrival of the goods on time.</p>
            </div>
          </li>
        </ul>
      </div>
      <div class="ad_1">
        <div class="ad_1Text">Responsible&nbsp;&nbsp;·&nbsp;&nbsp;Professional&nbsp;&nbsp;·&nbsp;&nbsp;Efficient</div>
      </div>
    </div>
    <div id="case" class="scrol-page">
      <h2 class="title"><span>Our Products</span></h2>
      <h5 class="infoText">The Company and our products are certified with KOSHER, HALAL, ISO9001, ISO2200, and other international certification.</h5>
    ...
    <div id="about" class="scrol-page">
      ...
      <div class="k1120">
        <div class="aboutBox">
          <h4>Gana Biotech</h4>
          <p>Located in Shanghai,China, Gana Biotechchnology is an innovative and leading manufacturer and supplier of food, feed additives, and different industrial chemicals, applied to meat, confectionary, pharmaceutical, drinks, dairy, animal feed, water treatment, oil-drilling,etc. Our main products focus on : seasonings&flavorings, thickeners,preservatives, plant extracts, amino acids and dehydrated Vegetables.</p>
          <p>Gana Biotech have developed into the leading supplier and solution provider of food & feed additives and ingredients, raw material of nutrition health products, with extensive influences all over the world, Gana Biotech also aims to promote industry transformation and development of innovative.</p>
          <p>With the concept of "Quality is the culture", we have been integrating the resources of domestic suppliers and demands of foreign customers, and committing to serve foreign enterprises, and creating values for them.</p>
          <p>Supervised by a professional team and well-cooperated national and third party laboratory, our quality is strictly controlled according to international standard like BP, USP and EP before delivery or shipment. Each batch of goods will be inspected to make sure everything is on good condition. Gana Biotech and our products are certified with KOSHER, HALAL, ISO9001, ISO2200, and other international certification.</p>
          <p>We look forward to be your loyal partner, in the pursuit of long-term win-win business relationships. </p>
        </div>
      </div>
    </div>
    ...
    <div id="contact" class="scrol-page">
      ...
      <div class="infoText"> How much you trust us, how many surprises we will make. Contact us for more details！</div>
        ...
        <div class="k1120 clearfix">
          ...
          <form action="/plus/diy.php"  enctype="multipart/form-data" method="post" >
            ...
            <div class="messageRow_2">
              <div class="messageBox">
                <div class="fromList">
                  <input type="text" placeholder="Your name" value='' name="full_name" id="full_name" />
                </div>
                <div class="fromList">
            ...
            <div class="messageRow_3">
              <div class="messageBox">
                ...
                <span class="fromListInfo">Contact information we will reply within 1 working day, information will be treated in confidence.</span> </div>
            </div>
          </form>
        </div>
      </div>
